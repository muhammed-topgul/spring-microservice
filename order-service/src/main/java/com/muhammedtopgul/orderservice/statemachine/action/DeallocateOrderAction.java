...
public class DeallocateOrderAction implements Action<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    public void execute(StateContext<BeerOrderStatusEnum, BeerOrderEventEnum> stateContext) {
        ...
        DeallocateOrderRequestEvent requestEvent = new DeallocateOrderRequestEvent(beerOrderMapper.toDto(beerOrderEntity));
        jmsTemplate.convertAndSend(JmsQueues.DEALLOCATE_ORDER_REQUEST_QUEUE, requestEvent);
